...
/**
* shared/_FSInterfaceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from frontEnd/Interface.idl
* Friday, December 2, 2016 6:48:31 PM EST
*/

public class _FSInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements shared.FSInterface
{

  public int bookFlight (String firsName, String lastName, String address, String phone, String destination, String date, int flightClass)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("bookFlight", true);
                $out.write_string (firsName);
                ...
                return bookFlight (firsName, lastName, address, phone, destination, date, flightClass        );
            } finally {
                _releaseReply ($in);
            }
  } // bookFlight
  ...
  public int addFlight (String destination, String date, int ec, int bus, int fir)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("addFlight", true);
                $out.write_string (destination);
                $out.write_string (date);
                $out.write_long (ec);
                $out.write_long (bus);
                ...
                return addFlight (destination, date, ec, bus, fir        );
            } finally {
                _releaseReply ($in);
            }
  } // addFlight

  public int removeFlight (int recordId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("removeFlight", true);
  ...
  public int transferReservation (String clientId, String currentCity, String otherCity)
  {
            ...
            try {
                ...
                return transferReservation (clientId, currentCity, otherCity        );
            } finally {
                _releaseReply ($in);
            }
  } // transferReservation
