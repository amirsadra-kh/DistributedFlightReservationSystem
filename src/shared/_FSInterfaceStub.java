...
public class _FSInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements shared.FSInterface
{
  ...
  public int bookFlight (String city, String firsName, String lastName, String address, String phone, String destination, String date, String flightClass)
  {
            ...
            try {
                ...
                return bookFlight (city, firsName, lastName, address, phone, destination, date, flightClass        );
            } finally {
                _releaseReply ($in);
            }
  } // bookFlight
  ...
  public String getBookedFlightCount (String city)
  {
            ...
            try {
                ...
                return getBookedFlightCount (city        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public int editRecord (String city, String recordId, String fieldName, String newValue)
  {
            ...
            try {
                ...
                return editRecord (city, recordId, fieldName, newValue        );
            } finally {
                _releaseReply ($in);
            }
  } // editRecord
  ...
  public int addFlight (String city, String destination, String date, String ec, String bus, String fir)
  {
            ...
            try {
                ...
                $out.write_string (date);
                $out.write_string (ec);
                $out.write_string (bus);
                $out.write_string (fir);
                $in = _invoke ($out);
                int $result = $in.read_long ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return addFlight (city, destination, date, ec, bus, fir        );
            } finally {
                _releaseReply ($in);
            }
  } // addFlight
  ...
  public int removeFlight (String city, String recordId)
  {
            ...
            try {
                ...
                return removeFlight (city, recordId        );
            } finally {
                _releaseReply ($in);
            }
  } // removeFlight
  ...
  public int transferReservation (String city, String clientId, String currentCity, String otherCity)
  {
            ...
            try {
                ...
                return transferReservation (city, clientId, currentCity, otherCity        );
            } finally {
                _releaseReply ($in);
            }
  } // transferReservation
