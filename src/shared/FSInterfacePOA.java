                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // shared/FSInterface/bookFlight
       {
         ...
         int $result = (int)0;
         $result = this.bookFlight (city, firsName, lastName, address, phone, destination, date, flightClass);
         out = $rh.createReply();
       ...
       case 1:  // shared/FSInterface/getBookedFlightCount
       {
         String city = in.read_string ();
         String $result = null;
         $result = this.getBookedFlightCount (city);
         out = $rh.createReply();
       ...
       case 2:  // shared/FSInterface/editRecord
       {
         ...
         int $result = (int)0;
         $result = this.editRecord (city, recordId, fieldName, newValue);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }
       ...
       case 3:  // shared/FSInterface/addFlight
       {
         ...
         int $result = (int)0;
         $result = this.addFlight (city, destination, date, ec, bus, fir);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }
       ...
       case 4:  // shared/FSInterface/removeFlight
       {
         ...
         String recordId = in.read_string ();
         int $result = (int)0;
         $result = this.removeFlight (city, recordId);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }
       ...
       case 5:  // shared/FSInterface/transferReservation
       {
         ...
         int $result = (int)0;
         $result = this.transferReservation (city, clientId, currentCity, otherCity);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }
